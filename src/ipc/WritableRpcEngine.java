...
public class WritableRpcEngine implements RpcEngine {
  ...
  public Server getServer(Class protocol,
    ...
    throws IOException {
    return new InternalServer(instance, conf, bindAddress, port, numHandlers, 
        verbose);
  }
  ...
  public static class InternalServer extends Server {
     ...
     */
    public InternalServer(Object instance, Configuration conf, String bindAddress,  int port,
